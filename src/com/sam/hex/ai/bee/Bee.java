...
public class Bee implements Runnable
{
    ...
    */
    ...
    public void run ()
    {
	while (active && Global.gameRunning)
	{
	    // If it is Bee's turn, makes a move.
	    if (Global.currentPlayer == team)
	    {
	    Point lastMove;
		if(Global.moveNumber>1) lastMove = new Point(Global.moveList.getmove().getX(), Global.moveList.getmove().getY());
		else lastMove=null;
		...
		else
		{
		    ...
		    BeeMove.move = new Point(bestMove.x - 1, bestMove.y - 1);
